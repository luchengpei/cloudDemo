		...
		<view v-else>
			<form @submit="formSubmit" v-show="current === 0">
				<view class="cu-form-group align-start">
					...
					<textarea name="title" maxlength="100" placeholder="请输入标题"></textarea>
				</view>
				<view class="cu-form-group align-start">
					<textarea name="content" maxlength="2000" placeholder="请输入内容"></textarea>
				</view>
				<view class="bg-white">
			...
			<form v-show="current === 1">
				<view class="bg-white">
					<view class="cu-form-group align-start">
						...
						<textarea  v-model="video.content" maxlength="100" placeholder="请输入内容"></textarea>
					</view>
